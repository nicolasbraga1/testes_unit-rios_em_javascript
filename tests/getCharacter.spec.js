...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    //X Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    //X Teste se a função retorna o objeto correto para o parâmetro 'Arya',
    //X Teste se a função retorna o objeto correto para o parâmetro 'Brienne',
    //X Teste se a função retorna o objeto correto para o parâmetro 'Melissandre',
    //X Teste se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.
